...
class News extends Controller {
    ...
    public function __construct() {
     ...
     public function index() {
		...
		if(!empty($action)) {
			switch($action) {
				...
				case 'edit':
					...
					break;
				case 'delete':
					$this->view->success = $this->model->newsDelete($_POST['id']);
					
					break;
				case 'archive':
					$this->view->success = $this->model->newsArchive($_POST['id']);
					break;
				case 'back':
		...
		$this->view->paging = ((int) $rowcount > (int) $this->entries_per_page) ? $this->model->paging($total_pages, $page, 'admin/news', 'pages') : '';
