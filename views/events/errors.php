		...
		<div class="newsitem">
			<div class="commentcount">
				<div class="comm-count">
					<p><?php echo  event['count']; ?></p>
				</div>
			</div>
			<p><?php echo $event['postdate'];?></p>
			<hr />
...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			...
			<div id="webform">
				<h2>Leave a Reply</h2>
				<?php echo Form::open(array('id' => 'replyForm', 'class' => 'form-horizontal', 'action' => URL . 'events/reply', 'method' => 'post', 'role' => 'form'));?>
