	...
	<div class="content_item_main">
		<div class="newsitem">
			<div id="webform">
				...
				<fieldset>
					<legend><h2>There has been an error:</h2></legend>
					<h3>You forgot to enter the following field(s)</h3>
					<ul id="validation">
				...
				<fieldset>
					...
					<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							...
							<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'first_name', 'id' => 'first_name', 'title' => 'Please enter your first name', 'value' => $this->data['first_name']));?>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							<label class="control-label" for="last_name">Surname</label>
							<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'last_name', 'id' => 'last_name', 'title' => 'Please enter your last name', 'value' => $this->data['last_name']));?>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							<label class="control-label" for="email">Email</label>
							<?php echo Form::input(array('type' => 'email', 'class' => 'form-control text-input', 'name' => 'email', 'id' => 'email', 'title' => 'Please enter your email address', 'value' => $this->data['email']));?>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							<label class="control-label" for="confemail">Confirm Email</label>
							<?php echo Form::input(array('type' => 'email', 'class' => 'form-control text-input', 'name' => 'confemail', 'id' => 'confemail', 'title' => 'Please confirm your email address', 'value' => 'Email'));?>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							<label class="control-label" for="email">Interests <span class="smalltxt">(optional)</span></label>
							<?php echo Form::textarea(array('rows' => '10', 'cols' => '50', 'class' => 'form-control text-input', 'name' => 'interests', 'id' => 'interests', 'title' => 'Please enter any interests/hobbies you have', 'value' => $this->data['interests']));?>
						</div>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="form-group has-feedback">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							...
							<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'username', 'id' => 'username', 'title' => 'Please enter a username', 'value' => $this->data['username']));?>
				...
				<fieldset>
					...
					<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							...
							<p class="help-block">Sign up for operation-braveheart.org.uk newsletter. This newsletter includes what fundraising events are happening soon, our latest news and any other points of interest. You can Opt-out at any time....so sign up and give it a try!! <a href="<?= URL; ?>privacy">Privacy Policy</a></p>
						</div>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							<p><?php echo Form::input(array('type' => 'checkbox', 'class' => 'radiobutton', 'name' => 'termscheck', 'id' => 'termscheck', 'value' => 'yes'));?> I have read and accepted the <a href="<?= URL; ?>terms"><span class="help-block">Terms &amp; Conditions</span></a></p>
						</div>
					</div>	
					<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							...
							<p class="help-block">Please enter the anti-spam image text.</p>
							<p class="btn btn-info btn-info btn-xs"><span class="glyphicon glyphicon-refresh"></span> Not readable? Change text</p>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
