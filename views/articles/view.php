...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			...
			<img class="img-responsive pull-right" src="<?=URL;?>public/images/content/<?php echo $article['photo'];?>">
...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<div id="webform">
				<h2>Leave a Reply</h2>
				<?php echo Form::open(array('id' => 'replyForm', 'action' => URL . 'articles/reply/' . $this->pageid, 'class' => 'form form-horizontal', 'method' => 'post', 'role' => 'form'));?>
				<div>
				...
				<div class="form-group">
						<div class="col-sm-8 col-md-8 col-sm-offset-1 col-md-offset-2">
							<div class="captchatext">
								<img id="captchimg" src="<?=URL;?>util/visual-captcha.php" width="200" height="60" alt="Visual CAPTCHA" />
							</div>
				...
				<?php echo Form::input(array('type' => 'hidden', 'name' => 'articleid', 'id' => 'newsid', 'value' => $this->articles[0]['id']));?>
