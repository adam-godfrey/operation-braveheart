...
<?php else:?>
<?php foreach($this->blog as $blogitem):?>
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			...
			<p><?php echo $blogitem['postdate'];?></p>
			<hr />
			<h2><?php echo $blogitem['title']; ?></h2>
			<p><?php echo nl2br($blogitem['content']);?></p>
		</div>
	</div>
</div>
<?php endforeach?>
...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			...
			<div id="webform">
				<h2>Leave a Reply</h2>
				<?php echo Form::open(array('id' => 'replyForm', 'class' => 'form-horizontal', 'action' => URL . 'blogs/reply', 'method' => 'post', 'role' => 'form'));?>
					...
					<?php echo Form::input(array('type' => 'hidden', 'name' => 'blogid', 'id' => 'blogdid', 'value' => $this->blog[0]['id']));?>
