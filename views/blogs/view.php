		...
		<div class="newsitem">
			...
			<div class="commentcount">
				<div class="comm-count">
					<p><?php echo $blog['count']; ?></p>
				</div>
			</div>
			<p><?php echo $blog['postdate'];?></p>
			<hr />
			<h2><?php echo $blog['title']; ?></h2>
			<img class="img-responsive pull-right" src="<?=URL;?>public/images/content/<?php echo $blog['photo'];?>">
...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<div id="webform">
				<h2>Leave a Reply</h2>
				<?php echo Form::open(array('id' => 'replyForm', 'action' => URL . 'blogs/reply/' . $this->pageid, 'class' => 'form form-horizontal', 'method' => 'post', 'role' => 'form'));?>
				<div>
				...
				<?php echo Form::input(array('type' => 'hidden', 'name' => 'blogid', 'id' => 'newsid', 'value' => $this->blogs[0]['id']));?>
...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<h2 class="comment"><?=$this->comm_count;?> Responses To <?=$this->blog_title;?></h2>
