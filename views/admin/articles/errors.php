...
<div class="box content_item">
	<div class="content_item_main">
		<div class="articleitem">
			<?php echo Form::open(array('enctype' => 'multipart/form-data', 'id' => 'adminForm', 'name' => 'adminForm', 'class' => 'form form-horizontal', 'action' => URL . 'admin/article/edit', 'method' => 'post', 'role' => 'form'));?>
			...
			<div id="form-submit" class="alert alert-success alert-dismissable">
				...
				<strong>Success!</strong> Article updated.
			</div>
			<?php else: ?>
			<div id="form-submit" class="alert alert-danger alert-dismissable">
				...
				<strong>Error!</strong> Article not updated.
			</div>
			<?php endif; ?>
			<?php endif; ?>
			<fieldset>
				<legend><h2>Article Content</h2></legend>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="article_title">TITLE</label>
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'article_title', 'id' => 'field_title', 'value' => $this->article['title']));?>
						<p class="help-block">Please enter a title for the article.</p>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="article_content">CONTENT</label>
						<?php echo Form::textarea(array('rows' => '20', 'cols' => '50', 'class' => 'form-control text-input', 'name' => 'article_content', 'id' => 'field_content', 'value' => $this->article['content']));?>
						<p class="help-block">Please enter the content for the article.</p>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="article_keywords">KEYWORDS</label>
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'article_keywords', 'id' => 'article_keywords', 'value' => $this->article['keywords']));?>
						<p class="help-block">Please enter some keywords/search phrases for the article (optional).</p>
						<p class="help-block">Keywords/search phrases must be separated by commas.</p>
					</div>
				</div>
			</fieldset>
			<?php echo Form::input(array('type' => 'hidden', 'name' => 'articleid', 'id' => 'articleid', 'value' => $this->article['id']));?>
			<?php echo Form::input(array('type' => 'hidden', 'name' => 'imgname', 'id' => 'imgname', 'value' =>  $this->article['image']));?>
			...
			<fieldset>
				<legend><h2>Article Image</h2></legend>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<p class="help-block">Please select an image for the article (optional).</p>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
			...
			<div id="output">
				<img id="preview-img" class="img-responsive" src="<?=URL;?>public/images/content/<?=$this->article['image'];?>" alt="<?=$this->article['alternate'];?>" title="<?=$this->article['alternate'];?>">
			</div>
		</div>
	</div>
</div>