...
<div class="box content_item">
	<div class="content_item_main">
		<div class="articleitem">
			<?php echo Form::open(array('enctype' => 'multipart/form-data', 'id' => 'adminForm', 'name' => 'adminForm', 'class' => 'form form-horizontal', 'action' => URL . 'admin/articles/add', 'method' => 'post', 'role' => 'form'));?>
			...
			<div id="form-submit" class="alert alert-danger alert-dismissable">
				...
				<strong>Error!</strong> Article not added.
			</div>
			<?php endif; ?>
			<?php endif; ?>
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'article_title', 'id' => 'field_title', 'placeholder' => 'Article title'));?>
						<span class="help-block">Please enter a title for the article.</span>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="article_content">CONTENT</label>
						<?php echo Form::textarea(array('rows' => '10', 'cols' => '50', 'class' => 'form-control text-input', 'name' => 'article_content', 'id' => 'field_content', 'placeholder' => 'Article content'));?>
						<span class="help-block">Please enter the content for the article.</span>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="article_keywords">KEYWORDS</label>
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'article_keywords', 'id' => 'article_keywords', '' => 'Keywords / tags'));?>
						<span class="help-block">Please enter some keywords/search phrases for the article (optional).</span>
			...
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<span class="help-block">Please select an image for the article (optional).</p>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
