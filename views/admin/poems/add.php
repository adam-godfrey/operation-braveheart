...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<?php echo Form::open(array('enctype' => 'multipart/form-data', 'id' => 'adminForm', 'name' => 'adminForm', 'class' => 'form form-horizontal', 'action' => URL . 'admin/poems/add', 'method' => 'post', 'role' => 'form'));?>
			...
			<div id="form-submit" class="alert alert-success alert-dismissable">
				...
				<strong>Success!</strong> Poem added.
			</div>
			<?php else: ?>
			<div id="form-submit" class="alert alert-danger alert-dismissable">
				...
				<strong>Error!</strong> Poem not added.
			</div>
			<?php endif; ?>
			<?php endif; ?>
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'poem_title', 'id' => 'field_title', 'placeholder' => 'Poem title'));?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'poem_author', 'id' => 'poem_author', 'placeholder' => 'Poem author'));?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::textarea(array('rows' => '10', 'cols' => '50', 'class' => 'form-control text-input', 'name' => 'poem_content', 'id' => 'field_content', 'placeholder' => 'Poem'));?>
