...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<?php echo Form::open(array('enctype' => 'multipart/form-data', 'name' => 'adminForm', 'id' => 'adminForm', 'action' => URL . 'admin/poems/edit', 'method' => 'post'));?>
			...
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="poem_title">TITLE</label><br />
						<?php echo Form::input(array('type' => 'text', 'class' => 'text-input', 'name' => 'poem_title', 'id' => 'field_title', 'value' => $this->poem[0]['title']));?>
						<span class="help-block">Please enter a title for the poem.</span>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="poem_content">POEM</label><br />
						<?php echo Form::textarea(array('rows' => '10', 'cols' => '50', 'class' => 'text-input', 'name' => 'poem_content', 'id' => 'field_content', 'value' => $this->poem[0]['content']));?>
						<span class="help-block">Please enter the poem.</span>
					</div>
				</div>
			</fieldset>
			<?php echo Form::input(array('type' => 'hidden', 'name' => 'poemid', 'id' => 'poemid', 'value' => $this->poem[0]['id']));?>
