...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<?php echo Form::open(array('id' => 'adminForm', 'name' => 'adminForm', 'class' => 'form form-horizontal', 'action' => URL . 'admin/links/add', 'method' => 'post', 'role' => 'form'));?>
			...
			<div id="form-submit" class="alert alert-success alert-dismissable">
				...
				<strong>Success!</strong> Link added.
			</div>
			<?php else: ?>
			<div id="form-submit" class="alert alert-danger alert-dismissable">
				...
				<strong>Error!</strong> Link not added.
			</div>
			<?php endif; ?>
			<?php endif; ?>
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'website_name', 'id' => 'website_name', 'placeholder' => 'Website name'));?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'url', 'class' => 'form-control text-input', 'name' => 'website_url', 'id' => 'website_url', 'placeholder' => 'Website URL'));?>
