...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<?php echo Form::open(array('id' => 'adminForm', 'name' => 'adminForm', 'class' => 'form form-horizontal', 'action' => URL . 'admin/events/add', 'method' => 'post', 'role' => 'form'));?>
			...
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'event_title', 'id' => 'event_title', 'placeholder' => 'Event title'));?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::textarea(array('rows' => '10', 'cols' => '50', 'class' => 'form-control text-input', 'name' => 'event_content', 'id' => 'event_content', 'placeholder' => 'Event content'));?>
			...
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'location', 'id' => 'location', 'placeholder' => 'Event location'));?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'postcode', 'id' => 'postcode', 'placeholder' => 'Event postcode'));?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'latitude', 'id' => 'latitude', 'value' => '', 'placeholder' => 'Latitude'));?>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="longitude">LONGITUDE</label>
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'longitude', 'id' => 'longitude', 'value' => '', 'placeholder' => 'Longitude'));?>
			...
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'eventdate', 'id' => 'eventdatepicker', 'placeholder' => 'Event date'));?>
			...
			<div id="output">
				<img id="preview-img" class="img-responsive" src="<?=URL;?>public/images/content/<?=$this->event['photo'];?>" alt="<?=$this->event['alternate'];?>" title="<?=$this->event['alternate'];?>">
			</div>
		</div>
	</div>
</div>