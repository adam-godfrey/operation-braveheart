...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<?php echo Form::open(array('id' => 'adminForm', 'name' => 'adminForm', 'class' => 'form form-horizontal', 'action' => URL . 'admin/events/edit', 'method' => 'post', 'role' => 'form'));?>
			...
			<div id="form-submit" class="alert alert-danger alert-dismissable">
				...
				<strong>Error!</strong> Event not updated.
			</div>
			<?php endif; ?>
			<?php endif; ?>
			<fieldset>
			...
			<?php echo Form::input(array('type' => 'hidden', 'name' => 'eventid', 'id' => 'eventid', 'value' => $this->event['id']));?>
			<?php echo Form::input(array('type' => 'hidden', 'name' => 'imgname', 'id' => 'imgname', 'value' =>  $this->event['image']));?>
