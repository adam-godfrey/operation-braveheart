...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<?php echo Form::open(array('enctype' => 'multipart/form-data', 'id' => 'adminForm', 'name' => 'adminForm', 'class' => 'form form-horizontal', 'action' => URL . 'admin/news/add', 'method' => 'post', 'role' => 'form'));?>
			...
			<div id="form-submit" class="alert alert-success alert-dismissable">
				...
				<strong>Success!</strong> News added.
			</div>
			<?php else: ?>
			<div id="form-submit" class="alert alert-danger alert-dismissable">
				...
				<strong>Error!</strong> News not added.
			</div>
			<?php endif; ?>
			<?php endif; ?>
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'news_title', 'id' => 'field_title', 'placeholder' => 'News title'));?>
						<span class="help-block">Please enter a title for the news.</span>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="news_content">CONTENT</label>
						<?php echo Form::textarea(array('rows' => '10', 'cols' => '50', 'class' => 'form-control text-input', 'name' => 'news_content', 'id' => 'field_content', 'placeholder' => 'News content'));?>
						<span class="help-block">Please enter the content for the news.</span>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						<label class="control-label" for="news_keywords">KEYWORDS</label>
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'news_keywords', 'id' => 'news_keywords', '' => 'Keywords / tags'));?>
						<span class="help-block">Please enter some keywords/search phrases for the news (optional).</span>
			...
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<span class="help-block">Please select an image for the news (optional).</span>
					</div>
				</div>
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
