...
<div class="box content_item">
	<div class="content_item_main">
		<div class="newsitem">
			<?php echo Form::open(array('id' => 'adminForm', 'name' => 'adminForm', 'class' => 'form form-horizontal', 'action' => URL . 'admin/shop/edit', 'method' => 'post', 'role' => 'form'));?>
			...
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'item_shortdesc', 'id' => 'item_shortdesc', 'value' => $this->shop['item_shortdesc']));?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::textarea(array('rows' => '10', 'cols' => '50', 'class' => 'form-control text-input', 'name' => 'item_fulldesc', 'id' => 'item_fulldesc', 'value' => $this->shop['item_fulldesc']));?>
								...
								<div class="controls-row">
									<div class="col-md-3">
										<label class="control-label radio inline">
											<?php echo Form::input(array('type' => 'radio', 'name' => 'is_clothing', 'id' => 'clear_all', 'value' => '0', ($this->shop['is_clothing'] == 0) ? 'checked' : ''));?> No
										</label>
									</div>
									<div class="col-md-4">
										<label class="control-label radio inline">
											<?php echo Form::input(array('type' => 'radio', 'name' => 'is_clothing', 'id' => 'clear_choice', 'value' => '1', ($this->shop['is_clothing'] == 1) ? 'checked' : ''));?> Yes
										</label>
									</div>
								</div>
							</div>
			...
			<?php echo Form::input(array('type' => 'hidden', 'name' => 'prodid', 'id' => 'prodid', 'value' => $this->shop['prodid']));?>
			<?php echo Form::input(array('type' => 'hidden', 'name' => 'imgname', 'id' => 'imgname', 'value' =>  $this->shop['image']));?>
