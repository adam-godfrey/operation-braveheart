...
<div class="box content_item">
	<div class="content_item_main">
		<div class="blogitem">
			<?php echo Form::open(array('enctype' => 'multipart/form-data', 'id' => 'adminForm', 'name' => 'adminForm', 'class' => 'form form-horizontal', 'action' => URL . 'admin/blogs/add', 'method' => 'post', 'role' => 'form'));?>
			...
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'blog_title', 'id' => 'field_title', 'placeholder' => 'Blog title'));?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::textarea(array('rows' => '10', 'cols' => '50', 'class' => 'form-control text-input', 'name' => 'blog_content', 'id' => 'field_content', 'placeholder' => 'Blog content'));?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<?php echo Form::input(array('type' => 'text', 'class' => 'form-control text-input', 'name' => 'blog_keywords', 'id' => 'blog_keywords', '' => 'Keywords / tags'));?>
