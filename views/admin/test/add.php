			...
			<fieldset>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<label class="formlabel" for="new_title">TITLE</label>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<label class="formlabel" for="news_content">CONTENT</label>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="form-group">
						...
						<label class="formlabel" for="news_keywords">KEYWORDS</label>
