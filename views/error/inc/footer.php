	...
	<script src="<?php echo URL; ?>public/js/jquery-ui-1.10.3.custom.min.js"></script>
	...
	<?php else: ?>
	<script type="text/javascript" src="<?php echo URL; ?>public/js/<?php echo $script; ?>.js"></script>
	<?php endif; ?>
	<?php endforeach; ?>	
	<?php endif; ?>
